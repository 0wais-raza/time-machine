...
export const CATALOG: HardwarePart[] = [
  // CPU
  {
    ...
    demand: 4,
    value: 4,
    specs: { Cores: "6C / 12T", Boost: "5.3 GHz", TDP: "105W" },
  },
  {
    id: "cpu-r7",
    slot: "cpu",
    ...
    demand: 5,
    value: 5,
    specs: { Cores: "8C / 16T", Boost: "5.2 GHz", Cache: "96MB 3D V-Cache" },
  },
  {
    id: "cpu-i9",
    slot: "cpu",
    ...
    demand: 3,
    value: 4,
    specs: { Cores: "24C / 32T", Boost: "6.0 GHz", TDP: "253W" },
  },
  {
    id: "cpu-tr",
    slot: "cpu",
    ...
    demand: 2,
    value: 3,
    specs: { Cores: "32C / 64T", Boost: "5.3 GHz", TDP: "350W" },
  },
  // GPU
  {
    id: "gpu-4060",
    ...
    demand: 4,
    value: 3,
    specs: { VRAM: "16GB GDDR6", Cores: "4352 CUDA", TGP: "165W" },
  },
  {
    id: "gpu-4080",
    slot: "gpu",
    ...
    demand: 5,
    value: 4,
    specs: { VRAM: "16GB GDDR6X", Cores: "10240 CUDA", TGP: "320W" },
  },
  {
    id: "gpu-5090",
    slot: "gpu",
    ...
    demand: 5,
    value: 5,
    specs: { VRAM: "32GB GDDR7", Cores: "21760 CUDA", TGP: "575W" },
  },
  {
    id: "gpu-7900",
    slot: "gpu",
    ...
    demand: 3,
    value: 4,
    specs: { VRAM: "24GB GDDR6", Cores: "6144 Stream", TGP: "355W" },
  },
  // RAM
  {
    id: "ram-16",
    ...
    demand: 3,
    value: 3,
    specs: { Capacity: "16GB (2x8)", Speed: "5600 MT/s", Latency: "CL36" },
  },
  {
    id: "ram-32",
    slot: "ram",
    ...
    demand: 5,
    value: 5,
    specs: { Capacity: "32GB (2x16)", Speed: "6400 MT/s", Latency: "CL32" },
  },
  {
    id: "ram-64",
    slot: "ram",
    brand: "Kingston",
    name: "Fury Renegade 64GB",
    price: 260,
    demand: 3,
    value: 4,
    specs: { Capacity: "64GB (2x32)", Speed: "6000 MT/s", Latency: "CL30" },
  },
  // Storage
  {
    id: "ssd-1tb",
    ...
    demand: 5,
    value: 5,
    specs: { Capacity: "1TB", Read: "7450 MB/s", Interface: "PCIe 4.0" },
  },
  {
    id: "ssd-4tb",
    slot: "storage",
    ...
    demand: 4,
    value: 4,
    specs: { Capacity: "4TB", Read: "7300 MB/s", Interface: "PCIe 4.0" },
  },
  {
    id: "hdd-8tb",
    slot: "storage",
    ...
    demand: 2,
    value: 3,
    specs: { Capacity: "8TB", RPM: "7200", Interface: "SATA III" },
  },
  // PSU
  {
    id: "psu-650",
    ...
    demand: 3,
    value: 4,
    specs: { Wattage: "650W", Rating: "80+ Gold", Modular: "Full" },
  },
  {
    id: "psu-1000",
    slot: "psu",
  ...
  },
  {
    ...
    slot: "psu",
    brand: "be quiet!",
    name: "Dark Power Pro 1600W",
    price: 320,
    demand: 2,
    value: 3,
    specs: { Wattage: "1600W", Rating: "80+ Titanium", Modular: "Full" },
  },
  // Cooling
  {
    id: "cool-air",
    ...
    demand: 4,
    value: 5,
    specs: { Type: "Dual-tower air", Fans: "2x 140mm", Noise: "24 dBA" },
  },
  {
    id: "cool-360",
    slot: "cooling",
    ...
    demand: 5,
    value: 5,
    specs: { Type: "360mm AIO", Fans: "3x 120mm", Pump: "PWM" },
  },
  {
    id: "cool-custom",
    slot: "cooling",
    brand: "EKWB",
    name: "Custom Loop Kit",
    price: 340,
    demand: 2,
    value: 3,
    specs: { Type: "Hard-line loop", Radiators: "2x 360mm", Coolant: "Clear" },
  },
  // Case
  {
    id: "case-mid",
    ...
    demand: 4,
    value: 5,
    specs: { Form: "Mid ATX", Panel: "Walnut / mesh", Fans: "2 incl." },
  },
  {
    id: "case-o11",
    slot: "case",
    ...
    demand: 5,
    value: 5,
    specs: { Form: "Mid ATX", Panel: "Dual tempered glass", Fans: "0 incl." },
  },
  {
    id: "case-o11v",
    slot: "case",
    ...
    demand: 5,
    value: 5,
    specs: { Form: "Mid ATX", Panel: "360° tempered glass", Style: "Showcase dual-chamber" },
  },
  {
    id: "case-h9",
    slot: "case",
    ...
    demand: 4,
    value: 4,
    specs: { Form: "Mid ATX", Panel: "Dual tempered glass", Fans: "10 capacity", Airflow: "High" },
  },
  {
    id: "case-y70",
    slot: "case",
  ...
  },
  {
    ...
    slot: "case",
    brand: "Corsair",
    name: "6500X Tempered Glass",
    price: 115,
    demand: 4,
    value: 4,
    specs: {
      Form: "Mid ATX",
      Panel: "Glass front + side",
      Airflow: "Dual-chamber",
      Fans: "0 incl.",
    },
  },
  {
    ...
    slot: "case",
    brand: "SSUPD",
    name: "Meshlicious SFF",
    price: 95,
    demand: 3,
    value: 4,
    specs: { Form: "Mini-ITX", Volume: "14.9L", Panel: "Mesh" },
  },
  // Lighting
  {
    id: "light-strip",
    slot: "lighting",
    brand: "Corsair",
    name: "iCUE LS100 Strip Kit",
    price: 35,
    demand: 3,
    value: 3,
    specs: { LEDs: "138 addressable", Zones: "4", Sync: "iCUE" },
  },
  {
    id: "light-fans",
    slot: "lighting",
    brand: "Lian Li",
    name: "Uni Fan SL Infinity x3",
    price: 70,
    demand: 5,
    value: 4,
    specs: { Fans: "3x 120mm", LEDs: "ARGB dual-ring", Daisy: "Yes" },
  },
  {
    id: "light-panel",
    slot: "lighting",
    brand: "Nanoleaf",
    name: "Shapes Hex Panels",
    price: 90,
    demand: 4,
    value: 3,
    specs: { Panels: "9 hex", Sync: "Screen mirror", Color: "16M" },
  },
  // Audio
  {
    id: "audio-dac",
    ...
    demand: 3,
    value: 5,
    specs: { DAC: "CS43198", Output: "1400mW", Rate: "384kHz / 32bit" },
  },
  {
    id: "audio-hd",
    slot: "audio",
    ...
    demand: 4,
    value: 5,
    specs: { Type: "Open-back", Impedance: "300Ω", Driver: "38mm" },
  },
  {
    id: "audio-mon",
    slot: "audio",
    brand: "Kali",
    name: "LP-6 V2 Monitors",
    price: 190,
    demand: 3,
    value: 4,
    specs: { Type: "Studio pair", Woofer: '6.5"', SPL: "115dB" },
  },
  {
    id: "audio-mic",
    slot: "audio",
    brand: "Shure",
    name: "SM7dB Broadcast Mic",
    price: 200,
    demand: 4,
    value: 4,
    specs: { Pattern: "Cardioid", Preamp: "Built-in +28dB", Mount: "XLR" },
  },
  // Display
  {
    id: "disp-1440",
    slot: "display",
    brand: "LG",
    name: "27GP850 1440p 180Hz",
    price: 150,
    demand: 5,
    value: 5,
    specs: { Panel: "Nano IPS", Refresh: "180Hz", Response: "1ms" },
  },
  {
    id: "disp-oled",
    slot: "display",
    brand: "ASUS",
    name: "PG32UCDM 4K OLED",
    price: 420,
    demand: 5,
    value: 4,
    specs: { Panel: "QD-OLED", Refresh: "240Hz", HDR: "True Black 400" },
  },
  {
    id: "disp-ultra",
    slot: "display",
    brand: "Samsung",
    name: "Odyssey G9 Ultrawide",
    price: 380,
    demand: 3,
    value: 3,
    specs: { Panel: 'VA 49"', Refresh: "240Hz", Ratio: "32:9" },
  },
  // Peripherals
  {
    id: "kb-75",
    slot: "peripheral",
    brand: "Keychron",
    name: "Q1 Pro Mechanical",
    price: 90,
    demand: 5,
    value: 5,
    specs: { Layout: "75%", Switches: "Hot-swap", Build: "CNC aluminum" },
  },
  {
    id: "mouse-sup",
    slot: "peripheral",
    ...
    demand: 5,
    value: 5,
    specs: { Weight: "60g", Sensor: "Hero 2 32K", Battery: "95h" },
  },
  {
    id: "chair-erg",
    slot: "peripheral",
    ...
    demand: 4,
    value: 4,
    specs: { Support: "PostureFit SL", Mesh: "8Z Pellicle", Warranty: "12y" },
  },
  {
    id: "desk-mat",
    slot: "peripheral",
    ...
    demand: 2,
    value: 3,
    specs: { Size: "Large", Material: "Merino wool", Finish: "Leather trim" },
  },
];

export const partById = (id: string): HardwarePart | undefined => CATALOG.find((p) => p.id === id);
